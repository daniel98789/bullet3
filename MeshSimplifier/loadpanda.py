...
p.resetDebugVisualizerCamera(
    cameraDistance=1.4, cameraYaw=40, cameraPitch=-30, cameraTargetPosition=[2, 0, 0])
x = 1
y = 0
z = 0
while (1):
    ...
    if curr_time - start_time > 2:
        ...
        #p.resetDebugVisualizerCamera(
        #    cameraDistance=1.4, cameraYaw=40, cameraPitch=-30, cameraTargetPosition=[x, 0, 0])
